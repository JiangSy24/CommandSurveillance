...
- (void)commonInit {
    ...
    self.selectedIndicatorColor = CSColorBtnBule;//[UIColor colorWithRed:0.74 green:0.18 blue:0.06 alpha:1];
...
//
//    NSDateComponents *selectComps = [DAYUtils dateComponentsFromDate:self.selectedDate];
    
//    return todayComps.year == dateComponents.year && todayComps.month == dateComponents.month && todayComps.day == dateComponents.day;
    return [NSString stringWithFormat:@"%lu/%@",(unsigned long) self->_visibleYear,stringOfMonth];
}
