...
- (void)setModelFrame:(ICMessageFrame *)modelFrame
{
    ...
    NSString *voicePath = modelFrame.model.mediaPath;//[self mediaPath:modelFrame.model.mediaPath];
    ...
    self.voiceIcon.centerY = self.voiceButton.centerY;
    self.durationLabel.centerY = self.voiceButton.centerY;
    self.durationLabel.textColor = self.modelFrame.model.isSender ? [UIColor whiteColor] : [UIColor grayColor];
}
