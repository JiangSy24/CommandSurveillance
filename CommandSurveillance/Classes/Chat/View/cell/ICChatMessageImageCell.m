...
- (void)setModelFrame:(ICMessageFrame *)modelFrame
{
    ...
    UIImage *image = [UIImage imageWithContentsOfFile:modelFrame.model.mediaPath];//[manager imageWithLocalPath:[manager imagePathWithName:modelFrame.model.mediaPath.lastPathComponent]];
