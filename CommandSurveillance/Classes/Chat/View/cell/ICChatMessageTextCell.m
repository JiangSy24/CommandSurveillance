...
- (void)setModelFrame:(ICMessageFrame *)modelFrame
{
    ...
    self.chatLabel.text = modelFrame.model.message.content;
    self.chatLabel.centerY = self.bubbleView.centerY;
...
//        _chatLabel.textColor = [UIColor redColor];
    }
    _chatLabel.textColor = self.modelFrame.model.isSender ? [UIColor whiteColor] : [UIColor blackColor];
    return _chatLabel;
}
